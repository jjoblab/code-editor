...
/**
 * Robolectric tests for {@link InProcessStreamConnectionProvider}.
 *
 * <p>Tests the custom ConnectedInputStream/ConnectedOutputStream that
 * replace the buggy PipedInputStream/PipedOutputStream for in-process LSP.</p>
 *
 * @author jo@Dev
 * @since v3.33.7
 */
...
public class InProcessStreamConnectionProviderTest {
    ...
    public void connectedStreams_largeWriteDoesNotBlock() throws Exception {
        ...
        // Write a large amount of data (100 KB) — should not block or crash.
