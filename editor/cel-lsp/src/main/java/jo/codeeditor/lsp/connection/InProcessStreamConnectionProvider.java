 ...
 *
 * <p>Remplace les {@link java.io.PipedInputStream}/
...
public class InProcessStreamConnectionProvider implements StreamConnectionProvider {
    ...
    public StreamPair start() {
        // Utilise des streams connectés custom au lieu de PipedInputStream.
        ...
        try {
            ...
            // Le serveur ne prend pas en charge connect() — il ne poussera
            // pas de notifications.
        } catch (java.lang.reflect.InvocationTargetException e) {
            // Journalise la cause pour que les échecs de connect() remontent.
