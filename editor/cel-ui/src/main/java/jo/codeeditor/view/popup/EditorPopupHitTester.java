...
public class EditorPopupHitTester {

    private final EditorView view;

    public EditorPopupHitTester(EditorView view) {
        this.view = view;
    }

    public int hitTestCompletionPopup(float x, float y) {
     ...
     */
    public void handleNavMenuTap(float x, float y, int rowIdx) {
    ...
    public int hitTestCodeActionsPopup(float x, float y) {
    ...
    public int hitTestGoToSymbolPopup(float x, float y) {
    ...
    public int hitTestDiagnosticPopup(float x, float y) {
